...
/**
 * An object that holds the weather descriptors used for determining biome
 * in the case that you cannot differentiate between Lush and Marsh biomes
 *
 * Does not contain 'Humid' because both biomes can have that weather descriptor,
 * so 'Humid' needs to be checked for separately
 */
export const biomeWeatherMap = {
  lush: [
    "Balmy",
    "Beautiful",
    "Bilious Storms",
